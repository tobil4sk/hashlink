...
HL_DEFINE_PRIM(HL_BOOL,gl_init,HL_NO_ARG);
HL_DEFINE_PRIM(HL_BOOL,gl_set_debug,HL_BOOL);
HL_DEFINE_PRIM(HL_BOOL,gl_is_context_lost,HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID,gl_clear,HL_I32);
HL_DEFINE_PRIM(HL_I32,gl_get_error,HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID,gl_scissor,HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_clear_color,HL_F64 HL_F64 HL_F64 HL_F64);
HL_DEFINE_PRIM(HL_VOID,gl_clear_depth,HL_F64);
HL_DEFINE_PRIM(HL_VOID,gl_clear_stencil,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_viewport,HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_finish,HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID,gl_flush,HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID,gl_pixel_storei,HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_BYTES,gl_get_string,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_polygon_mode,HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_polygon_offset,HL_F32 HL_F32);
HL_DEFINE_PRIM(HL_VOID,gl_enable,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_disable,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_cull_face,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_blend_func,HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_blend_func_separate,HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_blend_equation,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_blend_equation_separate,HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_depth_mask,HL_BOOL);
HL_DEFINE_PRIM(HL_VOID,gl_depth_func,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_color_mask,HL_BOOL HL_BOOL HL_BOOL HL_BOOL);
HL_DEFINE_PRIM(HL_VOID,gl_color_maski,HL_I32 HL_BOOL HL_BOOL HL_BOOL HL_BOOL);
HL_DEFINE_PRIM(HL_VOID,gl_stencil_mask_separate,HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_stencil_func_separate,HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_stencil_op_separate,HL_I32  HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_NULL(HL_I32),gl_create_program,HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID,gl_delete_program,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_bind_frag_data_location,HL_NULL(HL_I32) HL_I32 HL_STRING);
HL_DEFINE_PRIM(HL_VOID,gl_attach_shader,HL_NULL(HL_I32) HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_link_program,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_DYN,gl_get_program_parameter,HL_NULL(HL_I32) HL_I32);
HL_DEFINE_PRIM(HL_BYTES,gl_get_program_info_bytes,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_NULL(HL_I32),gl_get_uniform_location,HL_NULL(HL_I32) HL_STRING);
HL_DEFINE_PRIM(HL_I32,gl_get_attrib_location,HL_NULL(HL_I32) HL_STRING);
HL_DEFINE_PRIM(HL_VOID,gl_use_program,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_NULL(HL_I32),gl_create_shader,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_shader_source,HL_NULL(HL_I32) HL_STRING);
HL_DEFINE_PRIM(HL_VOID,gl_compile_shader,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_BYTES,gl_get_shader_info_bytes,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_DYN,gl_get_shader_parameter,HL_NULL(HL_I32) HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_delete_shader,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_NULL(HL_I32),gl_create_texture,HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID,gl_active_texture,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_bind_texture,HL_I32 HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_tex_parameteri,HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_tex_parameterf,HL_I32 HL_I32 HL_F32);
HL_DEFINE_PRIM(HL_VOID,gl_tex_image2d,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_BYTES);
HL_DEFINE_PRIM(HL_VOID,gl_tex_image3d,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_BYTES);
HL_DEFINE_PRIM(HL_VOID,gl_tex_storage2d,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_tex_storage3d,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_tex_image2d_multisample,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_BOOL);
HL_DEFINE_PRIM(HL_VOID,gl_compressed_tex_image2d,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_BYTES);
HL_DEFINE_PRIM(HL_VOID,gl_compressed_tex_image3d,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_BYTES);
HL_DEFINE_PRIM(HL_VOID,gl_tex_sub_image2d, HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_BYTES);
HL_DEFINE_PRIM(HL_VOID,gl_tex_sub_image3d, HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_BYTES);
HL_DEFINE_PRIM(HL_VOID,gl_compressed_tex_sub_image2d, HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_BYTES);
HL_DEFINE_PRIM(HL_VOID,gl_compressed_tex_sub_image3d, HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_BYTES);
HL_DEFINE_PRIM(HL_VOID,gl_generate_mipmap,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_delete_texture,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_blit_framebuffer,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_NULL(HL_I32),gl_create_framebuffer,HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID,gl_bind_framebuffer,HL_I32 HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_framebuffer_texture,HL_I32 HL_I32 HL_NULL(HL_I32) HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_framebuffer_texture2d,HL_I32 HL_I32 HL_I32 HL_NULL(HL_I32) HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_framebuffer_texture_layer,HL_I32 HL_I32 HL_NULL(HL_I32) HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_delete_framebuffer,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_read_pixels,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_I32 HL_BYTES);
HL_DEFINE_PRIM(HL_VOID,gl_read_buffer,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_draw_buffers,HL_I32 HL_BYTES);
HL_DEFINE_PRIM(HL_NULL(HL_I32),gl_create_renderbuffer,HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID,gl_bind_renderbuffer,HL_I32 HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_renderbuffer_storage,HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_renderbuffer_storage_multisample,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_framebuffer_renderbuffer,HL_I32 HL_I32 HL_I32 HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_delete_renderbuffer,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_NULL(HL_I32),gl_create_buffer,HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID,gl_bind_buffer,HL_I32 HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_bind_buffer_base,HL_I32 HL_I32 HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_buffer_data_size,HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_buffer_data,HL_I32 HL_I32 HL_BYTES HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_buffer_sub_data,HL_I32 HL_I32 HL_BYTES HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_get_buffer_sub_data,HL_I32 HL_I32 HL_BYTES HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_enable_vertex_attrib_array,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_disable_vertex_attrib_array,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_vertex_attrib_pointer,HL_I32 HL_I32 HL_I32 HL_BOOL HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_vertex_attrib_ipointer,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_delete_buffer,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_uniform1i,HL_NULL(HL_I32) HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_uniform4fv,HL_NULL(HL_I32) HL_BYTES HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_uniform_matrix4fv,HL_NULL(HL_I32) HL_BOOL HL_BYTES HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_bind_image_texture,HL_I32 HL_I32 HL_I32 HL_BOOL HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_dispatch_compute,HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_memory_barrier,HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_draw_elements,HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_draw_elements_instanced,HL_I32 HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_draw_arrays,HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_draw_arrays_instanced,HL_I32 HL_I32 HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_multi_draw_elements_indirect, HL_I32 HL_I32 HL_BYTES HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_VOID,gl_multi_draw_elements_indirect_count, HL_I32 HL_I32 HL_BYTES HL_BYTES HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_NULL(HL_I32),gl_create_vertex_array,HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID,gl_bind_vertex_array,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_delete_vertex_array,HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID,gl_vertex_attrib_divisor,HL_I32 HL_I32);

HL_DEFINE_PRIM(HL_NULL(HL_I32), gl_create_query, HL_NO_ARG);
HL_DEFINE_PRIM(HL_VOID, gl_delete_query, HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID, gl_begin_query, HL_I32 HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID, gl_end_query, HL_I32);
HL_DEFINE_PRIM(HL_BOOL, gl_query_result_available, HL_NULL(HL_I32));
HL_DEFINE_PRIM(HL_VOID, gl_query_counter, HL_NULL(HL_I32) HL_I32);
HL_DEFINE_PRIM(HL_F64, gl_query_result, HL_NULL(HL_I32));

HL_DEFINE_PRIM(HL_I32, gl_get_uniform_block_index, HL_NULL(HL_I32) HL_STRING);
HL_DEFINE_PRIM(HL_VOID, gl_uniform_block_binding, HL_NULL(HL_I32) HL_I32 HL_I32);
HL_DEFINE_PRIM(HL_I32, gl_get_program_resource_index, HL_NULL(HL_I32) HL_I32 HL_STRING);
HL_DEFINE_PRIM(HL_VOID, gl_shader_storage_block_binding, HL_NULL(HL_I32) HL_I32 HL_I32);

HL_DEFINE_PRIM(HL_I32, gl_get_config_parameter, HL_I32);
HL_DEFINE_PRIM(HL_BOOL, gl_has_extension, HL_STRING);
